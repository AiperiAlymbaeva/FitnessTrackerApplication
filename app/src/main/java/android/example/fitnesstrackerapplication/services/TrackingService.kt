package android.example.fitnesstrackerapplication.services
...
import android.example.fitnesstrackerapplication.other.Constants
...
import android.example.fitnesstrackerapplication.other.Constants.Companion.FASTEST_LOCATION_UPDATE_INTERVAL
import android.example.fitnesstrackerapplication.other.Constants.Companion.LOCATION_UPDATE_INTERVAL
import android.example.fitnesstrackerapplication.other.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import android.example.fitnesstrackerapplication.other.Constants.Companion.NOTIFICATION_ID
...
import android.example.fitnesstrackerapplication.other.Constants.Companion.NOTIFICATION_CHANNEL_ID as NOTIFICATION_CHANNEL_ID
...
class TrackingService : LifecycleService() {
    ...
    private fun updateLocationChecking(isTracking: Boolean) {
        if (isTracking) {
            if (RunUtility.hasLocationPermissions(this)) {
           ...
           timeRunInSeconds.observe(this) {
            if(!serviceKilled) {
                val notification = curNotification
                    .setContentText(RunUtility.getFormattedStopWatchTime(it * 1000L))
